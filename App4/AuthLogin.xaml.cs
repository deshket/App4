...
namespace App4
{
    ...
    public sealed partial class AuthLogin : Page
    {
        ...
        async public void GetAuthentication()
        {
            ...
            IMobileServiceSyncTable<User_Cred> toGetTable = App.MobileService.GetSyncTable<User_Cred>();

            List<User_Cred> items = await toGetTable
                .Where(predicate: User_Cred => User_Cred.UserID == txtBoxUserId.Text)
                .ToListAsync();
        ...
        private async Task BtnSync_ClickAsync(object sender, RoutedEventArgs e)
        {
           await InitLocalStoreAsync();
        }


        private void HplMainPage_Click(object sender, RoutedEventArgs e)
        {
